...
static const mxArray *b_emlrt_marshallOut(const int32_T u[900]);
...
static const mxArray *b_emlrt_marshallOut(const int32_T u[900])
{
  ...
  static const int32_T iv2[2] = { 1, 900 };
...
{
  real_T (*ret)[900];
  static const int32_T dims[2] = { 1, 900 };
  ...
  mxArray *plhs[3])
{
  ...
  spikes = (int32_T (*)[900])mxMalloc(sizeof(int32_T [900]));
  states = (int32_T (*)[900])mxMalloc(sizeof(int32_T [900]));
