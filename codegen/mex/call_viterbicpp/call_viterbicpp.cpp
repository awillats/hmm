...
void call_viterbicpp(const emlrtStack *sp, real_T nt, const boolean_T [300],
                     const real_T trs_[2], const real_T frs_[2], const real_T
                     pis_[2], emxArray_int32_T *statesGuess, emxArray_int32_T
                     *spikes, emxArray_int32_T *states)
{
  real_T b_trs_[2];
