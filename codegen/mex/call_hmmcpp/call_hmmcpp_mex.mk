...
MAKEFILE = call_hmmcpp_mex.mk

include call_hmmcpp_mex.mki


SRC_FILES =  \
	call_hmmcpp_data.cpp \
...
MEX_FILE_NAME_WO_EXT = call_hmmcpp_mex
...
%.$(OBJEXT) : /Users/adam/Documents/GitHub/hmmX/hmm/codegen/mex/call_hmmcpp/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /Users/adam/Documents/GitHub/hmmX/hmm/codegen/mex/call_hmmcpp/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /Users/adam/Documents/GitHub/hmmX/hmm/codegen/mex/call_hmmcpp/%.cu
	$(CC) $(CCFLAGS) "$<"
