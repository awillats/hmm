###########################################################################
## Makefile generated for MATLAB file/project 'call_hmmcpp'. 
## 
## Makefile     : call_hmmcpp_rtw.mk
## Generated on : Mon Feb 25 15:43:49 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: ./call_hmmcpp.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/adam/Documents/GitHub/hmmX/hmm/codegen/lib/call_hmmcpp
ARCH                      = maci64
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/adam/Documents/GitHub/hmmX/hmm -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=call_hmmcpp -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/call_hmmcpp_initialize.cpp $(START_DIR)/call_hmmcpp_terminate.cpp $(START_DIR)/call_hmmcpp.cpp
...
OBJS = call_hmmcpp_initialize.o call_hmmcpp_terminate.o call_hmmcpp.o
...
%.o : /Users/adam/Documents/GitHub/hmmX/hmm/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/adam/Documents/GitHub/hmmX/hmm/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
