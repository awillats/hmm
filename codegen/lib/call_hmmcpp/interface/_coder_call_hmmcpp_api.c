...
void call_hmmcpp_api(const mxArray * const prhs[1], int32_T nlhs)
{
  real_T in;
...
void call_hmmcpp_atexit(void)
{
  ...
  call_hmmcpp_xil_terminate();
}

void call_hmmcpp_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void call_hmmcpp_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_call_hmmcpp_api.c) */
